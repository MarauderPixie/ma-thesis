...
These research questions lead to the following set of hypotheses. The first regards XOR extrapolations during a transfer task whereas the second is about the learning apeed/success during training.
...
- **Hypothesis 2**
    ...
    - **H2.2** (undirected, _exploratory_): Interaction of learning accuracy between training blocks (3-12) and rule instructions in the blocked rule condition `[take out completely if not reported on later]`