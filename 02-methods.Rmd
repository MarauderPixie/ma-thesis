...
An online experiment has been conducted using the \_magpie 3 framework (https://magpie-ea.github.io/magpie-site/). This chapter describes the collected sample, the experimental setup and procedure, the data preparation and the statistical methods used for data analysis. The experiment has been pre-registered according to the guidelines of the Open Science Foundation (https://osf.io/)^[Pre-registration URL: [https://osf.io/wegm9](https://osf.io/wegm9)]. All code regarding the experiment and the data analysis can be found on the corresponding project page^[Project URL: [https://osf.io/gup7x/](https://osf.io/gup7x/)].
...
The second transfer phase in which participants are asked about their probability judgement for any given stimulus belonging to either category is not linked to a specific hypothesis. This study looks at these in an explanatory fashion. For example, probability judgements allow a look at decision gradients on an individual level or whether stimuli near the center of the grid are classified with as much certainty as the ones in the corners. In terms of feature similarity that is to say, stimuli that are closer to members of other categories than to their most distinctive class members.