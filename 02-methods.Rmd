...
- **(transfer 1) Chosen category:** `Nobz` or `Grot` on the full set of stimuli; of special relevance to the research question are the nine stimuli not shown (and learned) during the training phase (see. fig. \@(ref:ch2-stimuli))
...
```{r ch2-plot-exclusions, fig.cap="(ref:ch2-plot-exclusions)", out.height="25%"}
