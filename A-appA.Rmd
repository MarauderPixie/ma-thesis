...
(ref:apx-bfrc-h1) Bayes Factor robustness check for H1: the full model (both main efects and interaction) compared against the model assuming no effects with different priors.
