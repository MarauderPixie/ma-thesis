...
This chapter describes the results of the experiment and the analyses with respect to their given hypothesis. It starts with looking at the results of the transfer phase and then goes into the analysis of Hypotheses 1.1 through 1.3. Following that is the training phase with regard to hypothesis 2. It ends with an exploratory look at the probability judgements of the secodn transfer phase.
